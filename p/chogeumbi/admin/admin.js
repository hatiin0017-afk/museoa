...
(async () => {
  ...
  const fields={greeting:['메인 인사말',36],tagline:['메인 아래 멘트',70],birthday:['생일 (MM.DD)',5],debut:['데뷔일 (YYYY.MM.DD)',10],mbti:['MBTI',8],color:['대표 색상',20],scheduleKicker:['일정 상단 영문 멘트',35],scheduleBadge:['휴방 안내 영문 멘트',24],scheduleTitle:['일정 제목',22],scheduleSubtitle:['일정 소개 멘트',50],restNote:['휴방 안내 문구',50]};
